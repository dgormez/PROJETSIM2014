...
public class DcmMWL {
    ...
    private static final String USAGE = "dcmmwl DCMMWL@localhost:1112";
    private static final String DESCRIPTION =  "dcmmwl DCMMWL@localhost:1112";
    /*
    ...
    public List<DicomObject> query() throws IOException, InterruptedException {
        ...
        if (tc == null) {
            System.out.println("No Presentation Context");
