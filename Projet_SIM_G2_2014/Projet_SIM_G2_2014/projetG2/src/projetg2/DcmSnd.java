 ...
 * @version $Revision: 15821 $ $Date:: 2011-08-19#$
 * @since Oct 13, 2005
 */
public class DcmSnd extends StorageCommitmentService {
    ...
    public void send() {
        ...
        for ( ; i < n && (batchSize==0 || i < batchSize); ++i) {
            ...
            System.out.println("CUID :  "+info.cuid);
           // TransferCapability tc = assoc.getTransferCapabilityAsSCU(UID.SecondaryCaptureImageStorage);
            if (tc == null) {
                System.out.println();
